  ...
  app.get("/api/search", async (req, res) => {
    try {
      const rawFilters = {
        ...
        maxPrice: req.query.maxPrice ? Number(req.query.maxPrice) : 150000,
        ...
        mustHaveLand: req.query.mustHaveLand !== "false",
        includeUnknownLand: req.query.includeUnknownLand === "true",
